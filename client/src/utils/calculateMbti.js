...
export const DOG_QUESTIONS_META = [
  ...
  { id: 4, axis: 'S', is_reverse: false },
  { id: 5, axis: 'S', is_reverse: true },
  { id: 6, axis: 'S', is_reverse: false },
  { id: 7, axis: 'F', is_reverse: false },
  { id: 8, axis: 'F', is_reverse: false },
  { id: 9, axis: 'F', is_reverse: true },
  { id: 10, axis: 'J', is_reverse: false },
  { id: 11, axis: 'J', is_reverse: true },
  { id: 12, axis: 'J', is_reverse: false },
]
...
function replacePlaceholders(obj, petName, locale) {
  let displayPetName = petName ? capitalizeFirstLetter(petName) : ''
  if (!displayPetName) {
    if (locale === 'jp') displayPetName = '愛犬'
    else if (locale === 'ko') displayPetName = '우리 강아지'
    else displayPetName = 'Your pet'
  }
